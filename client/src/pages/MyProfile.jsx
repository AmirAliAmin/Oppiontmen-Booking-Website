  ...
  return (
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
      ...
      <p>
        {
          isEdit ?
          <p>
            <input className='bg-gray-50' type="text" value={userData.adress.line1} onChange={e =>setUserData(prev=>({...prev, adress:{...prev, line1:e.target.value}}))} />
            <br />
            <input className='bg-gray-50' type="text" value={userData.adress.line2} onChange={e =>setUserData(prev=>({...prev, adress:{...prev, line2:e.target.value}}))} />
      ...
      <div className='mt-10'>
        {
          isEdit ?
          <button className='border border-primary px-8 py-2 rounded-full hover:bg-primary hover:text-white cursor-pointer' onClick={()=>setIsEdit(false)}>Save information</button> :
          <button className='border border-primary px-8 py-2 rounded-full hover:bg-primary hover:text-white cursor-pointer'  onClick={()=>setIsEdit(true)}>Edit</button>
        }
      </div>
    </div>
  )
